...
### Agents without reference directories
3 agents have no `references/` directory — their domain knowledge fits in the `.agent.md` prompt:
...
- Agent files: `<kebab-case-name>.agent.md`
- Prompt files: `prompts/<kebab-case-name>.md` (matches agent filename without `.agent`)
- Reference directories: `references/<kebab-case-name>/`
- Knowledge chunks: `references/<kebab-case-name>/<kebab-case-topic>.md`
- TOC files: `references/<kebab-case-name>/_toc.md`
